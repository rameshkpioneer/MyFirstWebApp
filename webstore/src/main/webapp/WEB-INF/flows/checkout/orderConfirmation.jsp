	...
	<div class="container">
		<div class="row">
			<form:form modelAttribute="order" class="form-horizontal">
				...
				<div
					class="well col-xs-10 col-sm-10 col-md-6 colxs-
offset-1 col-sm-offset-1 col-md-offset-3">
							...
							<tbody>
								<c:forEach var="cartItem" items="${order.cart.cartItems}">
									<tr>
										...
										<td class="col-md-1 textcenter">${cartItem.product.unitPrice}
										</td>
								...
								<tr>
									...
									<td class="text-center textdanger">< h4> <strong>$${order.cart.grandTotal}
									</strong>
										</h4></td>
								</tr>
							</tbody>
