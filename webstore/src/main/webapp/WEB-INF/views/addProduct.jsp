...
<div class="col-lg-10">
<form:input id="unitPrice" path="unitPrice" rows = "2"/>
...
<div class="col-lg-10">
<form:input id="manufacturer" path="manufacturer" rows = "2"/>
</div>
</div>
...
<div class="col-lg-10">
<form:input id="category" path="category" rows = "2"/>
</div>
</div>
...
<div class="col-lg-10">
<form:input  id="unitsInStock" path="unitsInStock" rows = "2"/>
</div>
</div>
...
<div class="form-group">
<label class="control-label col-lg-2" for="unitsInOrder"><spring:message code="addProduct.form.unitsInOrder.label"/></label>
<div class="col-lg-10">
<form:input id="unitsInOrder" path="unitsInOrder" rows = "2"/>
</div>
</div>
...
<div class="form-group">
<label class="control-label col-lg-2" for="condition"><spring:message code="addProduct.form.condition.label"/>
</label>
<div class="col-lg-10">
